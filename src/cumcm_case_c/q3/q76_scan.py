...
一条命令复跑：
  <USER_HOME>\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\python\\python.exe ^
...
def main():
    ...
    L.append("")
    L.append("```powershell")
    L.append("<USER_HOME>\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\python\\python.exe "
             "D:\\CMUCU\\7.6对话\\code\\q76_scan.py")
    L.append("```")
    L.append("")
    L.append("## 只读声明")
